...
/*global jQuery */
	...
	var Outline = function (canvas, options, viewport) {
		...
		var settings = extend({}, defaults, options),
			...
			drawRect = function (rect, strokeWidth, strokeStyle, fillStyle, invert, diagonal) {
				...
				if (strokeStyle) {
					context.beginPath();
					context.rect(rect.left, rect.top, rect.width, rect.height*2);
			...
			drawElement = function (element, strokeWidth, strokeStyle, fillStyle, diagonal) {
				...
				diagonal = strokeWidth === 'auto' ? parseInt($element.css('border-top-width'), 10) :diagonal;
				drawRect(rect, strokeWidth, strokeStyle, fillStyle, false, diagonal);
			},
			applyStyles = function () {

				$.each(settings.styles, function (idx, style) {
					find(style.selector).each(function () {
						drawElement(this, style.strokeWidth, style.strokeStyle, style.fillStyle,style.diagonal);
					});
				});
			},
			drawViewport = function () {
				...
				drawRect(currentViewportRect, style.strokeWidth, style.strokeStyle, style.fillStyle, settings.invertViewport, settings.diagonal);
			},
			draw = function () {
			...
			onDragStart = function (event) {
				...
				$canvas.css('cursor', 'move').addClass('dragOn');
